...
# icon of the app
root.iconbitmap("asset/blueTree.ico")
# width and height
...
# define layout
chooseA_bt = tkinter.Button(
    root, text="Choose File A", bg="#00ffff", activebackground="#ff000f", borderwidth=5
)
chooseA_bt.grid(row=1, column=0, pady=10)

chooseB_bt = tkinter.Button(
    root,
    text="Choose File B",
    bg="black",
    fg="white",
    activebackground="#455005",
    borderwidth=5,
)
